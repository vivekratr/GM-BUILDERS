...
<div className="flex items-center justify-center capitalize font-medium">Article</div>
</div>

<b className="w-[19.938rem] relative text-[1.5rem] capitalize inline-block font-inria-serif text-white text-left">Is web 3 future of Internet ?</b>

<div className="w-[30.875rem] relative text-[1rem] capitalize font-inria-serif text-darkgray text-left inline-block">Lorem ipsum dolor sit amet consectetur. Sagittis urna adipiscing convallis pellentesque blandit facilisis.</div>

<div className="w-[5.625rem] relative text-[1rem] capitalize font-inria-serif text-white text-left inline-block">23 may 2024</div>
            </div>
