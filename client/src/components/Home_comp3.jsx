...
const Home_comp3 = () => {
  return (
    <div className='bg-black w-full py-[5.9375rem] flex-col items-start justify-center'>
      <b className="w-[52.313rem] relative text-[5.125rem] mx-auto capitalize pb-2 block font-inria-serif text-white text-center ">Write, Influence, Earn</b>
      <b className="w-[27.063rem] relative text-[1.625rem] mx-auto capitalize pb-[30px] block font-inria-serif text-[#969696] text-center">Get Paid for Your Articles and blogs</b>
      <div className='relative'>
        <div className='w-[1243px] h-[517px] flex items-center justify-center mx-auto relative'>
       
            <BackgroundImageDiv classs="pb-[33px]" imageUrl="https://i.imgur.com/pVG3JyL.jpeg">
...
<div className="relative leading-[1.25rem] font-medium">Start Writing</div>
</div>
                </div>
            </BackgroundImageDiv>
